...
function V3(t, e, n) {
  ...
  return t.$$set = (Y) => {
    ...
    2048 && (n(73, Vt = Object.keys(o)), Vt.sort()), t.$$.dirty[0] & /*$slices, $baseSlice, binaryMetrics, $overlapPlotMetric*/
    225 | t.$$.dirty[2] & /*metricNames*/
    4096) {
      let Y = a.find((pt) => !pt.isEmpty) ?? s;
      if (Y && Y.metrics) {
        let pt = Object.keys(Y.metrics);
        Dl(new Set(Q), new Set(pt)) || (n(74, Q = pt), Q.sort(), n(0, ke = Q.filter((Kt) => Y.metrics[Kt].type == "binary")), ke.length > 0 ? Fe(Nt, l = ke[0], l) : Fe(Nt, l = null, l));
      }
